...
public class ItemMaker {
	 ...
	 * @return this instance
	 */
	public ItemMaker loreLine(String line) {
		if (this.meta == null) {
			this.meta = stack.getItemMeta();
		}
	...
	/**
	 * @see ItemMaker#enchant(Enchantment, int, boolean)
	 */
	 ...
	 * @return this instance
	 */
	public ItemMaker enchant(Enchantment enchantment, int level, boolean unsafe) {
