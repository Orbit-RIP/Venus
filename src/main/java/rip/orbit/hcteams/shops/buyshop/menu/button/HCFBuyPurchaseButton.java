package rip.orbit.hcteams.shops.buyshop.menu.button;
...
public class HCFBuyPurchaseButton extends Button {

    private final Player player;
    private final HCFBuyShopBlocks buyBlocks;

    public HCFBuyPurchaseButton(Player player, HCFBuyShopBlocks buyBlocks) {
        this.player = player;
