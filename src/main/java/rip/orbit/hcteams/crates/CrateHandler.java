...
//	}
	...
	public static void give(CommandSender sender, @cc.fyre.proton.command.param.Parameter(name = "amount") int amount) {
	...
	public static void give(CommandSender sender, @cc.fyre.proton.command.param.Parameter(name = "player") Player target, @cc.fyre.proton.command.param.Parameter(name = "amount") int amount) {
		ItemStack key = HCF.getInstance().getCrateHandler().getKey();
		key.setAmount(amount);
