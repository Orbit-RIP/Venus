...
public class TeamDataCommands {
    ...
    public static void exportTeamData(CommandSender sender, @cc.fyre.proton.command.param.Parameter(name="file") String fileName) {
    ...
    public static void importTeamData(CommandSender sender, @cc.fyre.proton.command.param.Parameter(name="file") String fileName) {
