...
public class GeneratorCommand {
	...
	public static void giveGenerator(CommandSender sender, @cc.fyre.proton.command.param.Parameter(name = "target") Player target, @cc.fyre.proton.command.param.Parameter(name = "tier") int tier, @cc.fyre.proton.command.param.Parameter(name = "level") int level) {
