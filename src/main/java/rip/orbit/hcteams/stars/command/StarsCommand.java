...
public class StarsCommand {
	...
	public static void setStars(CommandSender sender, @cc.fyre.proton.command.param.Parameter(name = "target") UUID target, @cc.fyre.proton.command.param.Parameter(name = "amount") int amount) {
		StarsMap map = HCF.getInstance().getStarsMaps();
	...
	public static void addStars(CommandSender sender, @cc.fyre.proton.command.param.Parameter(name = "target") UUID target, @cc.fyre.proton.command.param.Parameter(name = "amount") int amount) {
		StarsMap map = HCF.getInstance().getStarsMaps();
