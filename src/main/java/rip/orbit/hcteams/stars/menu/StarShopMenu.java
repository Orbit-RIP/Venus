	...
	public static class ArmorUpgradeButton extends Button {
		...
		public List<String> getDescription(Player player) {
			return CC.translate(Arrays.asList(
					"&6&l┃ &fClick to upgrade the item in your hand",
					"&6&l┃ &fto &6" + display,
					" ",
					"&6&l┃ &fPrice&7: &6" + price + "✧"
			));
		}
	...
	public static class FeatherArmorUpgradeButton extends Button {
		...
		public List<String> getDescription(Player player) {
			return CC.translate(Arrays.asList(
					...
					"&6&l┃ &fto &6" + display,
					" ",
					"&6&l┃ &fYou need to have protection 2 on your",
					"&6&l┃ &fboots for this to work.",
					"&6&l┃ &fPrice&7: &6" + price + "✧"
			));
		}
		...
		public ItemStack getButtonItem(Player player) {
			return new ItemBuilder(item.getMaterial())
					...
					.lore(CC.translate(Arrays.asList(
							"&6&l┃ &fPrice&7: &6" + item.getPrice() + "✧",
							"&6&l┃ &fClick to purchase this item"
					)))
					.build();
		}
