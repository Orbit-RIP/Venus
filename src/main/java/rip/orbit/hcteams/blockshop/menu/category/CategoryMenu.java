...
public class CategoryMenu extends Menu {
	...
	public static class CategoryButton extends Button {
		...
		public List<String> getDescription(Player player) {
			return Collections.singletonList(CC.translate("&6&l┃ &fPrice&7: &6$" + blockType.getPrice()));
		}
		...
		public void clicked(Player player, int slot, ClickType clickType) {
			...
			Proton.getInstance().getEconomyHandler().withdraw(player.getUniqueId(), blockType.getPrice());
