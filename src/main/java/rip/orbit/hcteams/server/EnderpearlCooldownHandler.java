...
public class EnderpearlCooldownHandler implements Listener {
	...
	public static void reset(CommandSender sender, @cc.fyre.proton.command.param.Parameter(name = "player") Player uuid, @cc.fyre.proton.command.param.Parameter(name = "0") String string) {
