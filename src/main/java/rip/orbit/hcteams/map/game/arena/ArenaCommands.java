...
public class ArenaCommands {
    ...
    public static void createArena(Player player, @cc.fyre.proton.command.param.Parameter(name = "name") String arenaName) {
    ...
    public static void deleteArena(Player player, @cc.fyre.proton.command.param.Parameter(name = "arena") GameArena arena) {
    ...
    public static void setPointSpawn(Player player, @cc.fyre.proton.command.param.Parameter(name = "a/b") String point, @cc.fyre.proton.command.param.Parameter(name = "arena") GameArena arena) {
    ...
    public static void setSpectatorSpawn(Player player, @cc.fyre.proton.command.param.Parameter(name = "arena") GameArena arena) {
    ...
    public static void setBounds(Player player, @cc.fyre.proton.command.param.Parameter(name = "arena") GameArena arena) {
    ...
    public static void addType(Player player, @cc.fyre.proton.command.param.Parameter(name = "arena") GameArena arena, @cc.fyre.proton.command.param.Parameter(name = "gameType") GameType gameType) {
    ...
    public static void removeType(Player player, @cc.fyre.proton.command.param.Parameter(name = "arena") GameArena arena, @cc.fyre.proton.command.param.Parameter(name = "gameType") GameType gameType) {
