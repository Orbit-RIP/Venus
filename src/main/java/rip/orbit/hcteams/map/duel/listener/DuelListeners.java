...
public class DuelListeners implements Listener {
    ...
    public void onPlayerDeath(PlayerDeathEvent event) {
        ...
        for (Player member : duel.getPlayers()) {
            member.playSound(player.getLocation(), Sound.AMBIENCE_THUNDER, 10000F, 0.8F + Proton.RANDOM.nextFloat() * 0.2F);
            member.playSound(player.getLocation(), Sound.EXPLODE, 2F, 0.5F + Proton.RANDOM.nextFloat() * 0.2F);
