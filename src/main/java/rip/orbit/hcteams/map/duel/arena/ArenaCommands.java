...
public class ArenaCommands {
    ...
    public static void deleteArena(Player player, @cc.fyre.proton.command.param.Parameter(name = "arena") DuelArena arena) {
    ...
    public static void setPointSpawn(Player player, @cc.fyre.proton.command.param.Parameter(name = "a/b") String point, @cc.fyre.proton.command.param.Parameter(name = "arena") DuelArena arena) {
    ...
    public static void setBounds(Player player, @cc.fyre.proton.command.param.Parameter(name = "arena") DuelArena arena) {
