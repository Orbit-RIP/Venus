...
public class MobCommand {
    ...
    public static void spawnmob(Player sender, @cc.fyre.proton.command.param.Parameter(name="mob[,mob,mob...]") String mobs, @cc.fyre.proton.command.param.Parameter(name="amount", defaultValue="1") int amount) {
