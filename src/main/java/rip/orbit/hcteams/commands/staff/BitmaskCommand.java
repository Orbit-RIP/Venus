...
public class BitmaskCommand {
    ...
    public static void bitmaskInfo(Player sender, @cc.fyre.proton.command.param.Parameter(name="team") Team team) {
    ...
    public static void bitmaskAdd(Player sender, @cc.fyre.proton.command.param.Parameter(name="target") Team team, @cc.fyre.proton.command.param.Parameter(name="bitmask") DTRBitmask bitmask) {
        if (team.getOwner() != null) {
            sender.sendMessage(ChatColor.RED + "Bitmask flags cannot be applied to teams without a null leader.");
            return;
        }
    ...
    public static void bitmaskRemove(Player sender, @cc.fyre.proton.command.param.Parameter(name="team") Team team, @cc.fyre.proton.command.param.Parameter(name="bitmask") DTRBitmask bitmask) {
        if (team.getOwner() != null) {
            sender.sendMessage(ChatColor.RED + "Bitmask flags cannot be applied to teams without a null leader.");
            return;
        }
