...
public class TeamManageCommand {
    ...
    public static void teamLeader(Player sender, @cc.fyre.proton.command.param.Parameter(name = "team") Team team) {
        new SelectNewLeaderMenu(team).openMenu(sender);
    }

    @Command(names = {"manageteam promote"}, permission = "foxtrot.manage")
    public static void promoteTeam(Player sender, @cc.fyre.proton.command.param.Parameter(name = "team") Team team) {
        new PromoteMembersMenu(team).openMenu(sender);
    }

    @Command(names = {"manageteam demote"}, permission = "foxtrot.manage")
    public static void demoteTeam(Player sender, @cc.fyre.proton.command.param.Parameter(name = "team") Team team) {
        new DemoteMembersMenu(team).openMenu(sender);
    }


    @Command(names = {"manageteam kick"}, permission = "foxtrot.manage")
    public static void kickTeam(Player sender, @cc.fyre.proton.command.param.Parameter(name = "team") Team team) {
        new KickPlayersMenu(team).openMenu(sender);
    }


    @Command(names = {"manageteam balance"}, permission = "foxtrot.manage")
    public static void balanceTeam(Player sender, @cc.fyre.proton.command.param.Parameter(name = "team") Team team) {
    ...
    public static void dtrTeam(Player sender, @cc.fyre.proton.command.param.Parameter(name = "team") Team team) {
    ...
    public static void pointsTeam (Player sender, @cc.fyre.proton.command.param.Parameter(name = "team") Team team) {
    ...
    public static void renameTeam(Player sender, @cc.fyre.proton.command.param.Parameter(name = "team") Team team) {
    ...
    public static void muteTeam(Player sender, @cc.fyre.proton.command.param.Parameter(name = "team") Team team) {
    ...
    public static void manageTeam(Player sender, @cc.fyre.proton.command.param.Parameter(name = "team") Team team) {
