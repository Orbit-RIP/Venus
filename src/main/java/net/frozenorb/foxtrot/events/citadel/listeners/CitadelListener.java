...
public class CitadelListener implements Listener {
    ...
    public void onPlayerJoin(PlayerJoinEvent event) {
        ...
        if (playerTeam != null && Foxtrot.getInstance().getCitadelHandler().getCappers() != null &&
                Foxtrot.getInstance().getCitadelHandler().getCappers().contains(playerTeam.getUniqueId())) {
