package net.frozenorb.foxtrot.shops.sellshop.menu.button;
...
public class SellPurchaseButton extends Button {
    ...
    public List<String> getDescription(Player player) {
        ...
        description.add("");
        int amountInInventory = Math.min(sellBlocks.getAmount(), ServerHandler.countItems(player, sellBlocks.getItem().getType(), 0));
    ...
    public void clicked(Player player, int slot, ClickType clickType) {
        ...
        ServerHandler.removeItem(player, sellBlocks.getItem(), amountInInventory);
