...
public final class ExperienceManager {
     ...
     *
     * @Parameter player the player for this ExperienceManager object
     ...
     *
     * @Parameter hardMaxLevel the new hard max level
     */
     ...
     *
     * @Parameter maxLevel The highest level handled by the lookup tables
     */
     ...
     *
     * @Parameter amt Amount of XP, may be negative
     */
     ...
     *
     * @Parameter amt Amount of XP, should not be negative
     */
     ...
     *
     * @Parameter amt The amount to check for.
     ...
     *
     * @Parameter exp the amount to check for
     ...
     *
     * @Parameter level The level to check for.
