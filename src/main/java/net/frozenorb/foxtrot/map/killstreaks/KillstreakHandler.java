...
public class KillstreakHandler implements Listener {
    ...
    private void grantTeamKillstreakReward(Player player, Team team, int killstreak, int points) {
        ...
        team.sendMessage(ChatColor.GREEN + "Your team received " + points + " points thanks to " + ChatColor.YELLOW + ChatColor.BOLD + player.getName() + ChatColor.GREEN + "'s " + killstreak + " killstreak.");
    }
