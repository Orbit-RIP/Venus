...
public class   ForceDisbandAllCommand {
    ...
    public static void forceDisbandAll(CommandSender sender) {
        ...
        sender.sendMessage(ChatColor.RED + "Are you sure you want to disband all factions? Type " + ChatColor.DARK_RED
                + "/forcedisbandall confirm" + ChatColor.RED + " to confirm or "
                + ChatColor.GREEN + "/forcedisbandall cancel" + ChatColor.RED +" to cancel.");
    }
