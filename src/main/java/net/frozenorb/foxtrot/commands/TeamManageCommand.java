...
public class TeamManageCommand {
    ...
    @Command(names = {"manageteam dtr"}, permission = "foxtrot.manage", hidden = true)
    public static void dtrTeam(Player sender, @Parameter(name = "team") Team team) {
        if (sender.hasPermission("foxtrot.manage.setdtr")) {
            conversationDouble(sender, "§bEnter a new DTR for " + team.getName() + ".", (d) -> {
                team.setDTR(d.floatValue());
                sender.sendRawMessage(ChatColor.YELLOW + team.getName() + ChatColor.WHITE + " has a new DTR of " + ChatColor.YELLOW + d.floatValue() + ChatColor.WHITE + ".");
            });
        } else {
    ...
    @Command(names = {"manageteam mute"}, permission = "foxtrot.manage", hidden = true)
    ...
    @Command(names = {"manageteam manage"}, permission = "foxtrot.manage", hidden = true)
